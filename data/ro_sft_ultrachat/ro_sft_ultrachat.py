...
class UltraChat(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        file_paths = filter(lambda x: x.endswith(".json"), os.listdir("data/ro_sft_ultrachat"))  # multiple shards
        file_paths = list(map(lambda x: os.path.join("data/ro_sft_ultrachat", x), file_paths))
